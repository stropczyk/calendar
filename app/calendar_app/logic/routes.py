...
def login_with_google():
    ...
    # procedura dla aplikacji działające na maszynie lokalnej

    # scopes = 'openid https://www.googleapis.com/auth/userinfo.email'
    # flow = InstalledAppFlow.from_client_secrets_file('credentials.json', scopes=scopes)
    # user_creds = flow.run_local_server(port=0)
    #
    # user_info = get_user_info(user_creds)
    # user_email = user_info['email']
    # session['email'] = user_email
    #
    # flash('Thank you for logging with Google', 'success')
    # return redirect(url_for('main.event'))

    # procedura dla aplikacji działającej w docker container
